...
//             {experience.subtitle ||
//               "Internships, roles, and the work that shaped my craft."}
//           </p>
//         </div>

//         <div className="relative">
//           <div className="absolute left-4 top-0 h-full w-px bg-gradient-to-b from-neon-blue/50 via-neon-purple/40 to-transparent" />
...
//               >
//                 <span className="absolute left-2 top-6 h-4 w-4 rounded-full bg-neon-blue shadow-neon" />
//                 <GlassCard className="p-6 md:p-8">
//                   <div className="flex flex-wrap items-center gap-2 text-xs uppercase tracking-[0.2em] text-cyan-200/70">
//                     <span>{exp.year}</span>
//                     <span>•</span>
