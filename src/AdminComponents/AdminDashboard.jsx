  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background:
          "radial-gradient(ellipse at 70% 0%, rgba(6,182,212,0.07) 0%, transparent 55%), radial-gradient(ellipse at 10% 90%, rgba(139,92,246,0.06) 0%, transparent 55%), #080d1a",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span
              style={{ fontSize: "12px", color: "#475569", marginRight: "4px" }}
            >
              {user.email}
            </span>
            ...
            <button
              ...
              style={{
                ...
                color:
                  isSavingAll || !isSupabaseConfigured ? "#64748b" : "#fff",
                fontSize: "13px",
                fontWeight: 700,
                cursor:
                  isSavingAll || !isSupabaseConfigured
      ...
      >
        ...
        >
          ...
          {!isSupabaseConfigured && (
            ...
            >
              <span>⚠️</span>
              Supabase environment variables are missing. You can edit locally,
              but saving to backend will fail.
            </div>
          )}
